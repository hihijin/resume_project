  ...
  return (
    <Main>
      ...
      <div className="text noborder">
        프로젝트에서 팀장 역할을 맡아 회의 주도, 문서 및 일정 관리를 담당했고,
        팀 내 의사소통을 적극적으로 이끌어가며 소외되는 팀원이 없도록 했습니다.{" "}
        <br />
        회의 및 토의 시에는 모든 팀원들의 의견을 듣고 공정한 의사결정을 내리기
        위해 노력했습니다. 열린 마음으로 피드백을 주고받으며 팀원들의 의견을
        수렴하며 효율적인 협업환경을 조성했습니다.
        <br />
        <br />
        또한, 코드 리뷰를 통해 컴포넌트 분리를 중점으로 개선점을 찾고 코드의
        재사용성과 유지보수성을 고려하여 모듈화된 컴포넌트를 설계하고 구현하는
        데 신경을 썼습니다. 이를 통해 코드의 가독성과 유연성을 향상시키며,
        전체적인 프로젝트의 효율성을 높이는 데 기여했습니다.
        <br />
        <br />
